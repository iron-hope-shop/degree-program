...
% \textcolor{blue}{Example:  $f$ maps element (George, Homa, Frank, Alex, Jim, Dave, Ian, Bobby, Cathy, Emy) to (George, Homa, Frank, Alex, Jim, Dave, Ian, Bobby, Cathy, Emy) because George comes before Dave.  \\However $f$ maps (Homa, Frank, Alex, Jim, Dave, Ian, Bobby, Cathy, Emy, George) to (Homa, Frank, Alex, Jim, George, Ian, Bobby, Cathy, Emy, Dave) because George came after Dave in the input.}
...
How many different passwords are there that contain only digits and lower-case letters and satisfy the given restrictions?\\
    ...
    % \textcolor{blue}{Think about how to remove all the ones that don't have at least one digit.  What does a password contain if doesn't have at least one digit?}
%Enter your answer below this comment line.
...
% \textcolor{blue}{One way to do this is to write out the samples.}
...
% \textcolor{blue}{If you're not sure how to attack this one, maybe try picking a value for k and look for a pattern.}
%Enter your answer below this comment line.
$2(k-1)!/k! = 2/k$
\\\\
\end{enumerate}
