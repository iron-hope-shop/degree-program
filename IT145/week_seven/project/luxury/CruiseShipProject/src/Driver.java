...
public class Driver {
    ...
    public static void addShip() {
        try {
            ...
            String tName = newShipInput.nextLine();
            System.out.println("Balcony rooms: ");
            Int tBalcony = newShipInput.nextInt();
            System.out.println("Oceanview rooms: ");
            Int tOceanView = newShipInput.nextInt();
            System.out.println("Suite rooms: ");
            Int tSuite = newShipInput.nextInt();
            System.out.println("Interior rooms: ");
            Int tInterior = newShipInput.nextInt();
            System.out.println("In service: ");
            Boolean tInService = newShipInput.nextBoolean();
    ...
    public static void addCruise() {
        try {
            ...
            String tCruiseName = newCruiseInput.nextLine();
            System.out.println("Cruise ship name: ");
            String tShipName = newCruiseInput.nextLine();
            System.out.println("Departure port: ");
            String tDeparture = newCruiseInput.nextInt();
            System.out.println("Destination: ");
            String tDestination = newCruiseInput.nextInt();
            System.out.println("Return port: ");
            String tReturn = newCruiseInput.nextInt();
        } catch (NoSuchElementException e) {
            System.out.println("Invalid input " + e);
            break;
        }
